/*
 * @Author: your name
 * @Date: 2021-03-12 14:07:56
 * @LastEditTime: 2021-03-16 19:28:43
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /message_to_tf/src/tf_uav_to_map.cpp
 */
#include <ros/ros.h>
...
int main(int argc, char** argv){
    ...
    nh.param<std::string>("sensor_frame", sensorFrameId, std::string("iris_camera_link"));
    nh.param<std::string>("robot_frame", robotFrameId, std::string("iris_base_link"));
    ...
    nh.param<double>("sensor_transform_from_robot/rotation/r", R, -3.14);
    nh.param<double>("sensor_transform_from_robot/rotation/p", P, 0);
